...
let totalTime = brushTeeth + getUp + getDressed + findKeys + watchTv + letDogsOut + eatFood + videoGames
...
let neededTime = brushTeeth + getUp + getDressed + findKeys + letDogsOut
let spareTime = watchTv + eatFood + videoGames
let idealTime = totalTime - spareTime
/*:
