...
let totalOranges = cratesOfOranges * orangeWeight
let totalWaterMellons = crateWeight * waterMelonWeight
let total = totalOranges + totalWaterMellons
let exact = total / 2
let leftHandTruckSide = es / orangeWeight
let rightHandTruckSide = cratesOfOranges - leftHandTruckSide
